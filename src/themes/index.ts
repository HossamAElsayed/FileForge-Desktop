...
const destructiveTokens = {
  light: { "--destructive": "#dc2626", "--destructive-foreground": "#ffffff" },
  dark: { "--destructive": "#f87171", "--destructive-foreground": "#0f1117" },
};

function withShadcnTokens(
  ...
  return {
    ...
    "--primary": vars["--accent"],
    "--primary-foreground": vars["--accent-foreground"],
    "--ring": vars["--accent"],
    "--input": vars["--border"],
    "--popover": vars["--card"],
    "--popover-foreground": vars["--foreground"],
    "--secondary": vars["--muted"],
    "--secondary-foreground": vars["--foreground"],
    "--sidebar": vars["--muted"],
    "--sidebar-foreground": vars["--foreground"],
    "--sidebar-border": vars["--border"],
    "--sidebar-accent": vars["--accent-subtle"],
    "--sidebar-accent-foreground": vars["--foreground"],
    "--sidebar-primary": vars["--accent"],
    "--sidebar-primary-foreground": vars["--accent-foreground"],
    "--sidebar-ring": vars["--accent"],
    ...destructiveTokens[mode],
  };
}
...
function schemeTokens(
  ...
  return {
    light: withShadcnTokens({ ...baseVars, ...light }, "light"),
    dark: withShadcnTokens({ ...baseVars, ...dark }, "dark"),
  };
}
